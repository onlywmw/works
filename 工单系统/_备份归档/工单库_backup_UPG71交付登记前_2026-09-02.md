...
**分类**：能力线 · 元能力注册表（地基）
**状态**：✅ 方案 v0.3 定稿（架构稿 v0.3，评审 R2 有条件冻结 8.8——P0×3[consumer 独立性/Job 三件套/ApprovalGroup 执行语义]+P1×3[Schema Validation Gate/retry_policy 语义/bundle 最小接口]全吸收；设计稿 `C:\Users\Administrator\Desktop\MOV_元能力注册表_架构设计稿.md`）→ 🔨**已登记 @2026-09-02 待派单**（派单文本 `设计师/派单/UPG-71_元能力注册表地基_派单_2026-09-02.md`；MVP=纯新增静态资产+脚本，零运行时/请求链路改动）——待程序员认领 ｜ **优先级**：P1 ｜ **出单人**：设计师 ｜ **日期**：2026-09-02
