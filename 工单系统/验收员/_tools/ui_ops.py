...
# 2026-08-29 验收小修：支持环境变量覆盖（UPG-06 验收环境 adb=D:/Android/Sdk，设备=emulator-5558）
ADB = os.environ.get("UI_OPS_ADB", "C:/Users/Administrator/platform-tools/platform-tools/adb.exe")
DEV = os.environ.get("UI_OPS_DEV", "21770d7d")
